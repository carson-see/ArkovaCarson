...
_Last refreshed: 2026-05-03 by claude — claims verified against gcloud/MCP/CI output (six-PR merge wave: PRs #674 → 6c7702ae, #660 → 120c7032, #661 → 50ae8194, #670 → e80f7326, #672 → 46604cbb, #671 → 3496ac4b, each verifiable via `git show <sha>`; deploy run https://github.com/carson-see/ArkovaCarson/actions/runs/25293985448 promoted canary to 100% LATEST = arkova-worker-00569-tik on main `3496ac4ba723bffa659101495bd2da3641e96df0`; `curl https://arkova-worker-270018525501.us-central1.run.app/health` returned `{"status":"healthy","git_sha":"3496ac4ba723bffa659101495bd2da3641e96df0","checks":{"database":"ok","anchoring":"ok","kms":"ok"}}`; Supabase Management API list_migrations against project vzwyaatejekddvltxyye confirmed ledger rows `version: 20260503192636 / name: 0285_api_key_scope_vocabulary`, `version: 0285 / name: api_key_scope_vocabulary_canonical`, `version: 20260503193753 / name: 0286_attestation_evidence_public_metadata`, `version: 20260503220655 / name: contract_anchor_credential_types`; Jira transitions confirmed via MCP transitionJiraIssue — SCRUM-1132/1572/1573/1574/1575/1582/1583 all Done; Confluence page https://arkova.atlassian.net/wiki/spaces/A/pages/655425 updated to revision 5)._
