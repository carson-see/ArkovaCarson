...
- [ ] T2: public API, worker behavior, queues, AI behavior, anchoring, billing; merge-grade staging soak with exact SHA, changed-behavior, targeted, and load/concurrency evidence
- [ ] T3: migrations, data integrity, concurrency/fan-out, security, chain/treasury; longer soak plus clean-mirror or isolated staging and changed-behavior load/concurrency evidence
