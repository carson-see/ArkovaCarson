...
// =============================================================================
// P7-S5: JOB CLAIM TESTS — REMOVED 2026-04-26
// Migration 0236 (anchor backlog cleanup, 2026-04-24) deliberately dropped the
// anchoring_jobs table, auto_create_anchoring_job trigger, claim_anchoring_job
// and complete_anchoring_job RPCs as orphaned dead code (no worker code path
// claimed/completed jobs from this table). Tests removed to match.
// =============================================================================
