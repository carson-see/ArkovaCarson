...
| `0347` | `lane2/s1-reconciler-daily-sweep-caller` (PR #1260, Lane 2) | SCRUM-2349 | `0347_scrum2349_credit_conservation_invariant_fix.sql` | RESERVED — fixes the 0341 `org_credit_ledger_divergence` invariant. **Renumbered 0344→0347 on 2026-06-27 base refresh** (main advanced to 0345; open PRs #1257=0342, #1286=0346 → next free = 0347). Prod-apply-first, like 0343, before the migrations-vs-prod gate passes. T3 — fresh soak required. |
