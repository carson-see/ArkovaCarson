...
| `0365` | `lane2/scrum-2940-folders` / PR (this) | SCRUM-2940 | `0365_scrum2940_folders_table_and_anchor_link.sql` | RESERVED — pre-soak, file-only, NOT applied to prod/rig. T3 (touches `supabase/migrations/` + ALTERs `anchors`). `folders` table + RLS/FORCE + nullable `anchors.folder_id` (metadata-only add) + owner-scope join trigger |
