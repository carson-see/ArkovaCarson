...
| `0341` | `lane2/s1-0341-reconcile-to-main` (fixed version; PR #__RECONCILE_PR__) | SCRUM-2349 / 2350 | `0341_scrum2349_2350_credit_integrity_foundation.sql` | **APPLIED to prod 2026-06-23**; reconciling to `main` via PR #__RECONCILE_PR__ (FIXED ERROR-23514 ordering; §1.12 prod-proven exception) |
...
## Recent migrations (PR #__RECONCILE_PR__ — SCRUM-2349 / SCRUM-2350 — 0341 reconcile-to-main)
