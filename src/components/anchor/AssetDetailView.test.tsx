...
describe('AssetDetailView', () => {
  ...
  it('QR code URL uses production base URL not localhost (UAT3-04)', () => {
    ...
    // The implementation falls back to https://app.arkova.ai when unset, but
    // a populated env wins — and the assertion below specifically checks the
    // prod host, so we set it explicitly.
