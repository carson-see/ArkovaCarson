...
export function SecureDocumentDialog({
  ...
  const autoSelectTemplate = useCallback(async (detectedType: string) => {
    ...
    const typeMap: Record<string, string> = {
      ...
      'CPE': 'CPE', 'CPE_CREDIT': 'CPE', 'CONTINUING_PROFESSIONAL_EDUCATION': 'CPE',
      ...
      'ACCREDITATION': 'ACCREDITATION', 'ACCREDITED': 'ACCREDITATION', 'ACCREDITING_BODY': 'ACCREDITATION',
      ...
      'RESUME': 'RESUME', 'CV': 'RESUME', 'CURRICULUM_VITAE': 'RESUME',
      'MEDICAL': 'MEDICAL', 'HEALTH_RECORD': 'MEDICAL', 'IMMUNIZATION': 'MEDICAL',
      'MILITARY': 'MILITARY', 'DD214': 'MILITARY', 'SERVICE_RECORD': 'MILITARY',
      'IDENTITY': 'IDENTITY', 'PASSPORT': 'IDENTITY', 'DRIVERS_LICENSE': 'IDENTITY',
      'CONTRACT_PRESIGNING': 'CONTRACT_PRESIGNING', 'CONTRACT': 'CONTRACT_PRESIGNING', 'NDA': 'CONTRACT_PRESIGNING', 'AGREEMENT': 'CONTRACT_PRESIGNING',
      'CONTRACT_POSTSIGNING': 'CONTRACT_POSTSIGNING', 'SIGNED_CONTRACT': 'CONTRACT_POSTSIGNING', 'EXECUTED_AGREEMENT': 'CONTRACT_POSTSIGNING',
