...
const JURISDICTION_NOTICES: JurisdictionNotice[] = [
  ...
  },
  {
    ...
    rights: ['Access (Art. 8(a))', 'Rectification (Art. 8(c))', 'Deletion (Art. 8(e))', 'Consent revocation (Art. 8(d))', 'Complaint to SIC'],
    transferBasis: 'SIC adequacy list (US included) + SIC Model Contractual Clauses (Dec 2025)',
    breachTimeline: '15 business days (controller to SIC)',
  ...
  },
  {
    ...
    rights: ['Access (§30)', 'Portability (§31)', 'Object (§32)', 'Deletion (§33)', 'Restriction (§34)', 'Rectification (§35)', 'Withdraw consent (§19)'],
    transferBasis: 'SCCs aligned with ASEAN MCCs or GDPR SCCs referencing Thai PDPA',
    breachTimeline: '72 hours (controller to PDPC)',
  ...
  },
  {
    ...
    regulator: 'Personal Data Protection Commissioner (PDP Malaysia)',
    regulatorUrl: 'https://www.pdp.gov.my/',
    rights: ['Access (§30)', 'Correction (§34)', 'Withdraw consent (§38)', 'Prevent processing (§42)', 'Prevent direct marketing (§43)', 'Data portability (§43A)'],
    transferBasis: 'Risk-based Transfer Impact Assessment (§129 as amended 2024) + SCC-style contract terms',
    breachTimeline: '72 hours (data user to PDP Commissioner, 2025 regulations)',
