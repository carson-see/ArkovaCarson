 ...
 *
 * Generates a 12-word recovery phrase and derives a deterministic SHA-256
 * claim key from it. Used for the account activation / identity recovery flow.
 *
 * Words are drawn from a 2048-word BIP-39 English wordlist subset using
 * Web Crypto's getRandomValues for cryptographic randomness.
 * The full 2048-word BIP-39 list ensures ~132 bits of entropy for 12 words.
 */

// Minimal 2048-word BIP-39 English wordlist
// Source: https://github.com/bitcoin/bips/blob/master/bip-0039/english.txt
// We embed a representative slice here; in production this would be a full import.
const WORDLIST: string[] = [
  ...
  "coyote","crack","cradle","craft","cram","crane","crash","crazy",
  ...
  "heart","heavy","hedgehog","height","hello","helmet","help","hero",
  "hidden","high","hill","hint","hip","hire","history","hobby",
  "hockey","hold","hole","hollow","home","honey","hood","hope",
  "horn","horror","horse","hospital","host","hour","hover","hub",
  "huge","human","humble","humor","hundred","hungry","hunt","hurdle",
  "hurry","hurt","husband","hybrid","ice","icon","ignore","illness",
  "image","imitate","immense","immune","impact","impose","improve","impulse",
  "inbox","income","increase","index","indicate","indoor","industry","infant",
  "inflict","inform","inhale","inject","inner","innocent","input","inquiry",
  ...
  "lamp","language","laptop","large","later","laugh","laundry","lava",
  "law","lawn","lawsuit","layer","lazy","leader","learn","leave",
  "lecture","left","leg","legal","legend","lemon","lend","length",
  "lens","leopard","lesson","letter","level","liar","liberty","library",
  "license","life","lift","like","limb","lion","liquid","list",
  ...
  "magnet","maid","mail","main","major","make","mammal","mango",
  ...
  "memory","mention","mercy","merge","merit","merry","mesh","message",
  "metal","method","middle","midnight","milk","million","mimic","mind",
  "minimum","minor","minute","miracle","miss","mistake","mix","mixed",
  "mixture","mobile","model","modify","mom","monitor","monkey","monster",
  ...
  "neck","need","negative","neglect","neither","nephew","nerve","network",
  "neutral","never","news","next","nice","night","noble","noise",
  "nominee","noodle","normal","north","notable","note","nothing","notice",
  "novel","now","nuclear","number","nurse","nut","oak","obey",
  "object","oblige","obscure","obtain","ocean","october","odor","off",
  ...
  "rely","remain","remind","remove","render","renew","rent","reopen",
  ...
  "roof","rookie","rose","rotate","rough","royal","rubber","rude",
  "rug","rule","run","runway","rural","sad","saddle","sadness",
  "safe","sail","salad","salmon","salon","salt","salute","same",
  "sand","satisfy","satoshi","sauce","sausage","save","say","scale",
  "scan","scatter","scene","scheme","scissors","scorpion","scout","scrap",
  "screen","script","scrub","sea","search","season","seat","second",
  "secret","section","security","seek","select","sell","seminar","senior",
  "sense","service","session","settle","seven","shadow","shaft","shallow",
  "share","shed","shell","sheriff","shift","shine","ship","shock",
  "shoe","shoot","shop","short","shoulder","shove","shrimp","shrug",
  "shudder","shy","siege","sight","sign","silent","silk","silly",
  ...
  "vehicle","velvet","vendor","venture","verb","verify","version","very",
 ...
 * Uses Web Crypto getRandomValues to pick words from the BIP-39 wordlist.
 */
export function generateRecoveryPhrase(): string[] {
  ...
  for (let i = 0; i < 12; i++) {
    // Modulo bias is negligible at this scale (2048 words, 16-bit random)
...
/**
 * Derive a deterministic SHA-256 claim key from a recovery phrase.
 * The claim key is stored server-side and used to verify ownership
 * without storing the phrase itself.
 */
export async function deriveClaimKey(phrase: string[]): Promise<string> {
  const normalized = phrase.join(' ').toLowerCase().trim();
