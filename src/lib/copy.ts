...
export const PUBLIC_FOOTER_LABELS = {
  ...
  COPYRIGHT: 'Arkova',
  STEP_PREFIX: 'Step',
  POWERED_BY: 'Powered by Arkova — immutable document integrity verification',
} as const;
...
export const USE_CASES_LABELS = {
  ...
  FAQ_1_A: 'Arkova generates a cryptographic fingerprint of your document entirely in your browser. Only this fingerprint is sent to our servers and secured on an immutable public record. To verify, anyone can re-generate the fingerprint from the original document and compare it to the secured record.',
  FAQ_2_Q: 'How long does verification take?',
  FAQ_2_A: 'Fingerprint generation is instant. Securing to the public record typically completes within 10-30 minutes. Once secured, verification is instant and permanent.',
  FAQ_3_Q: 'Can a secured record be altered or deleted?',
  FAQ_3_A: 'No. Once a fingerprint is secured on the immutable public record, it cannot be modified, deleted, or tampered with by anyone — including Arkova. This is the foundation of the platform\'s trust model.',
  FAQ_4_Q: 'What types of documents can I secure?',
  FAQ_4_A: 'Arkova supports 21 credential types including degrees, licenses, certificates, legal documents, financial records, and more. Any digital document can be fingerprinted and secured.',
