# services/worker — historical change log

Dated per-story narrative moved out of `agents.md` on 2026-08-01 so the guide
stays a guide. Nothing here was rewritten — these are the original entries,
verbatim. Newest first.

Durable rules, the Bitcoin path table, and current live findings live in
[`./agents.md`](./agents.md).
...
## HARDENING-5 historical snapshot (2026-03-10) — SUPERSEDED
