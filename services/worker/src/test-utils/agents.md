...
- **professional-education-migration.test.ts** — Static regression checks for the 0315 CPE/CLE foundation migration, including metadata columns, registry RLS posture, and secured-anchor immutability hooks.
