...
## Files
- `cron.ts` — HTTP-triggered cron endpoints. Cloud Scheduler hits these. Includes `POST /jobs/anchor-expiry-sweep` (SCRUM-1736) and `POST /jobs/provider-registry-refresh-overdue` (SCRUM-1949).
