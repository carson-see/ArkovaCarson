...
describe('NPH-05: SOS Fetcher', () => {
  it('returns empty when flag is disabled', async () => {
    ...
    const result = await fetchSosEntities(makeMock().client);
...
describe('NPH-06: Licensing Board Fetcher', () => {
  it('returns empty when flag is disabled', async () => {
    ...
    const result = await fetchLicensingBoardRecords(makeMock().client);
    expect(result).toEqual([]);
  });
});
...
describe('NPH-07: Insurance License Fetcher', () => {
  it('returns empty when flag is disabled', async () => {
    ...
    const result = await fetchInsuranceLicenses(makeMock().client);
    expect(result).toEqual([]);
  });
});
...
describe('NPH-08: CLE Fetcher', () => {
  it('returns empty when flag is disabled', async () => {
    ...
    const result = await fetchCleRecords(makeMock().client);
    expect(result).toEqual([]);
  });
});
...
describe('NPH-09: Certification Fetcher', () => {
  it('returns empty when flag is disabled', async () => {
    ...
    const result = await fetchCertificationRecords(makeMock().client);
    expect(result).toEqual([]);
  });
});
...
describe('NPH-10: IPEDS Fetcher', () => {
  it('returns zeros when flag is disabled', async () => {
    ...
    const result = await fetchIpedsInstitutions(makeMock().client);
