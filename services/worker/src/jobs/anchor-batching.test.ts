...
// PostgREST filter-width limits and their tests moved to
// `utils/postgrest-filter.ts` / `utils/postgrest-filter.test.ts` — they are a
// wire-shape concern, not an anchoring one.
