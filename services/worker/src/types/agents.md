...
Same manual patch as `src/types/agents.md` — migration `0375` (unmerged, file-only) adds `anchors.fingerprint_source`. Regenerate for real once `0375` lands on a reachable project.
