...
- subType: Fine-grained sub-type WITHIN the credentialType. Valid values by type:
...
FRAUD REASONING FEW-SHOTS (GRE-03):
Use the OBSERVE→IDENTIFY→CLASSIFY→VERIFY→ASSESS reasoning protocol for fraud detection.
Each example includes reasoning, concerns, and fraudSignals to show how to think through fraud analysis.

Example 134 — Diploma mill with life-experience degree (CRITICAL fraud):
Input: "Rochville University. Online Division. Master of Business Administration. Awarded to [NAME_REDACTED]. This degree is awarded based on professional life experience and portfolio assessment. No traditional coursework required. Enrollment fee: $399. Certificate shipped within 5 business days."
Output: {"credentialType":"DEGREE","issuerName":"Rochville University","degreeLevel":"Master","fieldOfStudy":"Business Administration","reasoning":"OBSERVE: Document claims to be from Rochville University, offering an MBA based on life experience with no coursework. IDENTIFY: Rochville University is in the known diploma mill database. CLASSIFY: This is a classic diploma mill credential — life experience claim, no coursework, fast delivery, and fee-based. VERIFY: Issuer NOT found in any accredited institution database. ASSESS: CRITICAL risk — known diploma mill with multiple fraud indicators.","concerns":["Rochville University is a known diploma mill","Degree awarded without coursework based on life experience","Fee-based degree with rapid delivery (5 business days)"],"fraudSignals":["EXPIRED_ISSUER","MISSING_ACCREDITATION","FORMAT_ANOMALY"],"confidence":0.10}

Example 135 — Date manipulation (issued after expiry):
Input: "State of Florida. Board of Professional Engineers. [NAME_REDACTED]. PE License No. 67890. Original Issue Date: September 1, 2029. Expiration Date: March 31, 2026. Status: Active."
Output: {"credentialType":"LICENSE","issuerName":"Florida Board of Professional Engineers","issuedDate":"2029-09-01","expiryDate":"2026-03-31","fieldOfStudy":"Engineering","licenseNumber":"67890","jurisdiction":"Florida, USA","reasoning":"OBSERVE: License claims issue date of 2029 but expiry of 2026 — the credential expires before it was issued. IDENTIFY: This is a temporal impossibility — no legitimate credential can expire before its issue date. CLASSIFY: Date manipulation, likely a forged or altered document. VERIFY: The Board of Professional Engineers is a legitimate issuer, but the dates are internally contradictory. ASSESS: HIGH risk — date manipulation detected on an otherwise legitimate-looking credential.","concerns":["Issue date (2029-09-01) is after expiry date (2026-03-31)","Temporal impossibility suggests document tampering"],"fraudSignals":["SUSPICIOUS_DATES"],"confidence":0.30}

Example 136 — Fake accreditation body:
Input: "International Open University. Bachelor of Science in Information Technology. [NAME_REDACTED]. Conferred: August 2025. Accredited by the World Association of Universities and Colleges. Registration No. WA-2025-IT-4567."
Output: {"credentialType":"DEGREE","issuerName":"International Open University","issuedDate":"2025-08-01","fieldOfStudy":"Information Technology","degreeLevel":"Bachelor","accreditingBody":"World Association of Universities and Colleges","reasoning":"OBSERVE: Degree claims accreditation from 'World Association of Universities and Colleges'. IDENTIFY: This accrediting body is known to be fraudulent — it is not recognized by any national education authority. CLASSIFY: Fake accreditation is a primary indicator of diploma mill operations. VERIFY: Neither the institution nor the accreditor appear in verified databases. ASSESS: HIGH risk — fraudulent accrediting body combined with unrecognized institution.","concerns":["World Association of Universities and Colleges is a known fake accreditor","International Open University matches suspicious naming patterns","No legitimate accreditation found"],"fraudSignals":["MISSING_ACCREDITATION","EXPIRED_ISSUER"],"confidence":0.20}

Example 137 — Credential forgery (font/format anomalies):
Input: "HARVARD UNIVERSIYT. ScHool of Law. Juris Doctor. [NAME_REDACTED]. Conferred on the 15th day of MAY, 2025. Cambridge, Massachusets. Signed by the Dean and the President of the University."
Output: {"credentialType":"DEGREE","issuerName":"Harvard University","issuedDate":"2025-05-15","fieldOfStudy":"Law","degreeLevel":"Doctorate","jurisdiction":"Massachusetts, USA","reasoning":"OBSERVE: Document claims to be from Harvard but contains multiple spelling errors: 'UNIVERSIYT', 'Massachusets'. Mixed case patterns ('ScHool') suggest text manipulation. IDENTIFY: Legitimate Harvard diplomas would never contain such errors — this indicates forgery or alteration. CLASSIFY: Format anomaly consistent with document fabrication using text substitution. VERIFY: Harvard University exists in verified databases, but this document does not match known Harvard formatting. ASSESS: HIGH risk — spelling errors and formatting inconsistencies are strong indicators of forgery.","concerns":["Multiple spelling errors in institution name and location","Mixed-case anomalies suggest text substitution","Formatting inconsistent with known Harvard diploma templates"],"fraudSignals":["FORMAT_ANOMALY"],"confidence":0.35}

Example 138 — Legitimate but expired credential (NO fraud — expiry is normal lifecycle):
Input: "State of New York. Department of Education. Licensed Clinical Psychologist. [NAME_REDACTED]. License No. PSY-012345. Original Issue: January 15, 2018. Expiration: January 14, 2021. Status: Expired."
Output: {"credentialType":"LICENSE","issuerName":"New York Department of Education","issuedDate":"2018-01-15","expiryDate":"2021-01-14","fieldOfStudy":"Clinical Psychology","licenseNumber":"PSY-012345","jurisdiction":"New York, USA","reasoning":"OBSERVE: License was issued in 2018 and expired in 2021. Status is explicitly marked as 'Expired'. IDENTIFY: This is a standard credential lifecycle — licenses expire and must be renewed. CLASSIFY: No fraud indicators present. Expiration is normal, not suspicious. VERIFY: NY Department of Education is a verified legitimate issuer. ASSESS: LOW risk — this is a legitimate credential that has simply reached its natural expiration date.","concerns":[],"fraudSignals":[],"confidence":0.82}

Example 139 — Legitimate but unusual credential (NO fraud — edge case):
Input: "Royal College of Veterinary Surgeons. Certificate of Specialization. [NAME_REDACTED]. Recognized Specialist in Veterinary Cardiology. Awarded: November 2024. London, United Kingdom. Accredited by European Board of Veterinary Specialisation."
Output: {"credentialType":"CERTIFICATE","issuerName":"Royal College of Veterinary Surgeons","issuedDate":"2024-11-01","fieldOfStudy":"Veterinary Cardiology","accreditingBody":"European Board of Veterinary Specialisation","jurisdiction":"United Kingdom","reasoning":"OBSERVE: Specialized veterinary cardiology certificate from RCVS with European board accreditation. IDENTIFY: While niche, veterinary specialization is a legitimate credential pathway. CLASSIFY: No fraud indicators — unfamiliar specialization does not equal suspicious. VERIFY: RCVS is a well-known professional body in the UK. ASSESS: LOW risk — legitimate specialist credential from a recognized professional body.","concerns":[],"fraudSignals":[],"confidence":0.87}

Example 140 — Kenyan professional credential (international — NO fraud):
Input: "Council of Legal Education Kenya. Advocate of the High Court of Kenya. [NAME_REDACTED]. Admitted to the Roll of Advocates on 15th March 2024. Certificate No. ADV/2024/1567. Nairobi."
Output: {"credentialType":"LICENSE","issuerName":"Council of Legal Education Kenya","issuedDate":"2024-03-15","fieldOfStudy":"Law","licenseNumber":"ADV/2024/1567","jurisdiction":"Kenya","reasoning":"OBSERVE: Legal admission certificate from the Council of Legal Education Kenya with a standard certificate number format. IDENTIFY: This is a legitimate professional legal credential from Kenya's recognized legal education authority. CLASSIFY: International credential — unfamiliarity with Kenyan legal system does not indicate fraud. VERIFY: Council of Legal Education is Kenya's statutory body for legal education. ASSESS: LOW risk — legitimate international professional credential with consistent formatting and plausible details.","concerns":[],"fraudSignals":[],"confidence":0.85}

Example 141 — Australian nursing registration (international — NO fraud):
Input: "Australian Health Practitioner Regulation Agency. AHPRA. Registration Certificate. [NAME_REDACTED]. Registered Nurse. Registration Number: NMW0002345678. Registration Type: General. Expiry: 30 June 2026. Division: Nursing and Midwifery Board of Australia."
Output: {"credentialType":"LICENSE","issuerName":"Australian Health Practitioner Regulation Agency","issuedDate":"2025-07-01","expiryDate":"2026-06-30","fieldOfStudy":"Nursing","licenseNumber":"NMW0002345678","jurisdiction":"Australia","reasoning":"OBSERVE: Nursing registration from AHPRA with standard Australian registration number format (NMW prefix). IDENTIFY: AHPRA is Australia's national health practitioner regulation agency — a legitimate and well-known body. CLASSIFY: Standard international healthcare credential. VERIFY: AHPRA format and registration number pattern are consistent with known Australian healthcare credentials. ASSESS: LOW risk — legitimate Australian healthcare credential with proper formatting.","concerns":[],"fraudSignals":[],"confidence":0.88}

Example 142 — Borderline case (suspicious but not conclusive):
Input: "Pacific Western University. Master of Science in Management. [NAME_REDACTED]. Conferred: May 2024. Los Angeles, California. This institution is authorized by the State of California."
Output: {"credentialType":"DEGREE","issuerName":"Pacific Western University","issuedDate":"2024-05-01","fieldOfStudy":"Management","degreeLevel":"Master","jurisdiction":"California, USA","reasoning":"OBSERVE: Degree from Pacific Western University claiming California state authorization. IDENTIFY: Pacific Western University appears in diploma mill databases. 'State authorization' is not the same as accreditation — many unaccredited schools are technically 'authorized' to operate. CLASSIFY: Known unaccredited institution with misleading accreditation language. VERIFY: Not found in DAPIP or CHEA accredited institution databases. ASSESS: CRITICAL risk — known diploma mill using misleading authorization language.","concerns":["Pacific Western University is in the known diploma mill database","'State authorized' is not equivalent to accredited","Not found in any accredited institution database"],"fraudSignals":["EXPIRED_ISSUER","MISSING_ACCREDITATION"],"confidence":0.15}

Example 143 — Multiple fraud signals combined (CRITICAL):
Input: "Cambridge International University. Doctor of Philosophy. [NAME_REDACTED]. Awarded based on extensive professional experience and published works. No residency requirement. Accredited by International Accreditation Association. Processing time: 14 days. Total fee: $850."
Output: {"credentialType":"DEGREE","issuerName":"Cambridge International University","degreeLevel":"Doctorate","fieldOfStudy":"General Studies","reasoning":"OBSERVE: PhD from 'Cambridge International University' with no residency, experience-based, 14-day processing, $850 fee, and accreditation from 'International Accreditation Association'. IDENTIFY: Multiple red flags — the institution name mimics Cambridge but is a known diploma mill. The accreditor is fake. The processing model (fee + days) is textbook diploma mill. CLASSIFY: Composite fraud — known mill, fake accreditor, implausible claims. VERIFY: Neither institution nor accreditor found in any legitimate database. ASSESS: CRITICAL risk — every factor is a fraud indicator.","concerns":["Cambridge International University is a known diploma mill","International Accreditation Association is a known fake accreditor","PhD awarded without residency or coursework","Fee-based with 14-day processing — classic diploma mill model"],"fraudSignals":["EXPIRED_ISSUER","MISSING_ACCREDITATION","FORMAT_ANOMALY"],"confidence":0.05}`;
