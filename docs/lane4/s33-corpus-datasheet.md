# S3.3 Golden Held-Out Corpus — Datasheet (Wave 1, Revision 9)

**Authored by:** Lane 4 (Corpus & Data) · **Initial date:** 2026-07-10 · **Revision 9:** 2026-07-13 · **Status:** PRODUCER RESUBMISSION BLOCKED ON L3 PREREQUISITE REVIEW — NOT SUBMITTED FOR L3 ACCEPTANCE (per `docs/lane3/s33-batch-acceptance-protocol.md`, PR #1494 — producer/acceptor separation, CTO R11/R12; Lane 4 does not self-certify)
...
- Current producer revision: `S33-W1` revision 9; the datasheet pins the complete manifest file at exact raw-file SHA-256 `c51eaffbec190fdcf02d1e04d1a56596abd865a4bf0ee0056c31f139941f7d12` (also recorded in `s33-wave1-entry-datasheet.json`).
...
Wave-1 entries carry `provenance: "authored-s33-lane4"`. The producer manifest pins revision-9 direct parent/predecessor `506ff62340db8f838ce68bc46ddfa6407735ce3c`, Lane-3 support base `dd3ae1edecb005730762277daf17e15d8009459d`, source blobs (`4ac117c1663c6aefb63c7715440744af0e0b6a23` licensing, `5000824f2bd4dd7ac9cd58243daeb7ba23c4c0cd` AU/KE, and `a261cf690c930040f7dee0361ed29d73d1d23426` OOD), and all unchanged normalized-input fingerprints. None of these producer pins is the L3 acceptance/freeze commit. Leakage wiring, formal acceptance, and the named held-out freeze remain L3-owned pre-window work.
