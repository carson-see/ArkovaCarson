...
Internal evidence UUIDs must not appear in API responses, SDK models, UI copy, or screenshots. The metadata migration is `supabase/migrations/0283_attestation_evidence_public_metadata.sql`.
