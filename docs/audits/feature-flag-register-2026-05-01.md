...
| `ENABLE_AI_EXTRACTION` | P2 | roadmap-or-optional | .env.example=false; docs/reference/ENV.md=false; frontend-switchboard=true; supabase-seed-default=false; supabase-seed-value=true | scripts/deploy-worker.sh:35, .env.example:105, supabase/seed.sql:202 |
...
| `ENABLE_AI_FRAUD` | P2 | roadmap-or-optional | docs/reference/ENV.md=false; frontend-switchboard=true; supabase-seed-default=false; supabase-seed-value=true | supabase/seed.sql:204, docs/reference/ENV.md:403, docs/reference/ENV.md:407 |
| `ENABLE_AI_REPORTS` | P2 | roadmap-or-optional | docs/reference/ENV.md=false; frontend-switchboard=true; supabase-seed-default=false; supabase-seed-value=true | supabase/seed.sql:206, docs/reference/ENV.md:404, .github/workflows/deploy-worker.yml:140 |
...
| `ENABLE_ATTESTATION_ANCHORING` | P2 | platform-switchboard | frontend-switchboard=true | src/pages/PlatformControlsPage.tsx:52, supabase/migrations/0086_attestation_anchoring_flag.sql:1, supabase/migrations/0086_attestation_anchoring_flag.sql:4 |
| `ENABLE_BATCH_ANCHORING` | P2 | platform-switchboard | frontend-switchboard=false | src/pages/PlatformControlsPage.tsx:60, docs/stories/11_mvp_launch_gaps.md:621, docs/stories/11_mvp_launch_gaps.md:629 |
...
| `ENABLE_GRC_INTEGRATIONS` | P0 | launch-critical | docs/reference/ENV.md=false; supabase-seed-default=false; supabase-seed-value=false; worker-config=false | supabase/seed.sql:208, docs/reference/ENV.md:345, scripts/ci/snapshots/worker-env-adhoc-baseline.json:37 |
...
| `ENABLE_PROD_NETWORK_ANCHORING` | P0 | launch-critical | .env.example=false; docs/reference/ENV.md=false; frontend-switchboard=false; supabase-seed-default=false; supabase-seed-value=false | docs/BETA_PRODUCTION_READINESS.md:193, scripts/deploy-worker.sh:33, scripts/deploy-worker.sh:47 |
...
| `ENABLE_SEMANTIC_SEARCH` | P2 | roadmap-or-optional | .env.example=false; docs/reference/ENV.md=false; frontend-switchboard=true; supabase-seed-default=false; supabase-seed-value=true | .env.example:106, supabase/seed.sql:203, docs/reference/ENV.md:402 |
...
| `ENABLE_VEREMARK_WEBHOOK` | P2 | roadmap-or-optional | docs/reference/ENV.md=false; worker-config=false | docs/reference/ENV.md:330, docs/reference/ENV.md:331, docs/integrations/background-checks-spike.md:14 |
| `ENABLE_VERIFICATION_API` | P0 | launch-critical | .env.example=false; docs/reference/ENV.md=false; frontend-switchboard=true; supabase-seed-default=false; supabase-seed-value=true; worker-config=true | scripts/deploy-worker.sh:36, .env.example:63, supabase/seed.sql:205 |
...
| `USE_MOCKS` | P0 | environment-safety | .env.example=false; docs/reference/ENV.md=false | .env.example:22, services/worker/src/stripe/client.ts:7, docs/reference/ENV.md:63 |
