...
| --- | --- | --- | --- | --- |
| `ENABLE_ADES_SIGNATURES` | P2 | roadmap-or-optional | docs/reference/ENV.md=false; worker-config=false | docs/reference/ENV.md:352, scripts/ci/snapshots/worker-env-adhoc-baseline.json:31, docs/bugs/bug_log.md:70 |
| `ENABLE_AI_EXTRACTION` | P0 | launch-critical | .env.example=false; docs/reference/ENV.md=false; frontend-switchboard=true; supabase-seed-default=false; supabase-seed-value=true | .env.example:105, scripts/deploy-worker.sh:35, docs/reference/ENV.md:401 |
| `ENABLE_AI_FALLBACK` | P3 | unclassified | .env.example=false; docs/reference/ENV.md=false; worker-config=false | .env.example:97, docs/reference/ENV.md:147, scripts/ci/snapshots/worker-env-adhoc-baseline.json:32 |
| `ENABLE_AI_FRAUD` | P0 | launch-critical | docs/reference/ENV.md=false; frontend-switchboard=true; supabase-seed-default=false; supabase-seed-value=true | docs/reference/ENV.md:403, docs/reference/ENV.md:407, supabase/seed.sql:204 |
| `ENABLE_AI_REPORTS` | P0 | launch-critical | docs/reference/ENV.md=false; frontend-switchboard=true; supabase-seed-default=false; supabase-seed-value=true | docs/reference/ENV.md:404, supabase/seed.sql:206, .github/workflows/deploy-worker.yml:140 |
| `ENABLE_ALLOCATION_ROLLOVER` | P1 | launch-critical | docs/reference/ENV.md=false; worker-config=false | docs/reference/ENV.md:298, scripts/ci/snapshots/worker-env-adhoc-baseline.json:33, docs/runbooks/billing/phase-3-rollover-grace.md:32 |
...
| `ENABLE_ATTESTATION_ANCHORING` | P2 | platform-switchboard | frontend-switchboard=true | supabase/migrations/0086_attestation_anchoring_flag.sql:1, supabase/migrations/0086_attestation_anchoring_flag.sql:4, supabase/migrations/0086_attestation_anchoring_flag.sql:8 |
...
| `ENABLE_COMPLIANCE_ENGINE` | P0 | launch-critical | No parsed default | docs/launch/first-client-launch-command-center-2026-05-01.md:90, supabase/migrations/0196_compliance_engine_flags.sql:3, supabase/migrations/0196_compliance_engine_flags.sql:20 |
...
| `ENABLE_NESSIE_RAG_RECOMMENDATIONS` | P2 | roadmap-or-optional | docs/reference/ENV.md=false; worker-config=false | docs/reference/ENV.md:389, scripts/ci/snapshots/worker-env-adhoc-baseline.json:39, docs/runbooks/nca-audit-uat.md:77 |
...
| `ENABLE_PROD_NETWORK_ANCHORING` | P0 | launch-critical | .env.example=false; docs/reference/ENV.md=false; frontend-switchboard=false; supabase-seed-default=false; supabase-seed-value=false | docs/BETA_PRODUCTION_READINESS.md:193, .env.example:104, scripts/deploy-worker.sh:33 |
...
| `ENABLE_REPORTS` | P0 | launch-critical | frontend-switchboard=true; supabase-seed-default=true; supabase-seed-value=true | supabase/seed.sql:200, src/pages/PlatformControlsPage.tsx:79, docs/launch/first-client-launch-command-center-2026-05-01.md:90 |
| `ENABLE_RULES_ENGINE` | P0 | launch-critical | docs/reference/ENV.md=true; worker-config=true | docs/reference/ENV.md:219, scripts/ci/snapshots/worker-env-adhoc-baseline.json:41, docs/runbooks/sec-harden/sec-harden-02-secret-manager-migration.md:121 |
...
| `ENABLE_SEMANTIC_SEARCH` | P0 | launch-critical | .env.example=false; docs/reference/ENV.md=false; frontend-switchboard=true; supabase-seed-default=false; supabase-seed-value=true | .env.example:106, docs/reference/ENV.md:402, supabase/seed.sql:203 |
...
| `ENABLE_VEREMARK_WEBHOOK` | P2 | roadmap-or-optional | docs/reference/ENV.md=false; worker-config=false | docs/reference/ENV.md:330, docs/reference/ENV.md:331, scripts/ci/snapshots/worker-env-adhoc-baseline.json:45 |
| `ENABLE_VERIFICATION_API` | P0 | launch-critical | .env.example=false; docs/reference/ENV.md=false; frontend-switchboard=true; supabase-seed-default=false; supabase-seed-value=true; worker-config=true | .env.example:63, scripts/deploy-worker.sh:36, docs/reference/ENV.md:74 |
...
| `ENABLE_VISUAL_FRAUD_DETECTION` | P0 | launch-critical | docs/reference/ENV.md=false; worker-config=false | docs/reference/ENV.md:405, docs/launch/first-client-launch-command-center-2026-05-01.md:90, services/worker/src/config.test.ts:478 |
...
| `ENABLE_WORKSPACE_RENEWAL` | P0 | launch-critical | docs/reference/ENV.md=false; worker-config=false | docs/reference/ENV.md:336, scripts/ci/snapshots/worker-env-adhoc-baseline.json:49, services/worker/src/config.ts:248 |
