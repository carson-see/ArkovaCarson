...
Resolution of the drift findings in this section is tracked in SCRUM-1621 and is out of scope for this audit/register PR.
...
| P0 | `ENABLE_DOCUSIGN_OAUTH` | launch-critical | DocuSign organization account connection | docs/reference/ENV.md=false; worker-config=false | env-doc, integration-kill-switch, worker-code, worker-config, worker-registry |
| P0 | `ENABLE_DOCUSIGN_WEBHOOK` | launch-critical | DocuSign completed-contract automation | docs/reference/ENV.md=false; worker-config=false | env-doc, integration-kill-switch, worker-code, worker-config, worker-registry |
| P0 | `ENABLE_DRIVE_OAUTH` | launch-critical | Google Drive account connection | docs/reference/ENV.md=false; worker-config=false | docs, env-doc, integration-kill-switch, worker-code, worker-config, worker-registry |
| P0 | `ENABLE_DRIVE_WEBHOOK` | launch-critical | Google Drive watched-folder automation | docs/reference/ENV.md=false; worker-config=false | env-doc, integration-kill-switch, worker-code, worker-config, worker-registry |
...
| P0 | `ENABLE_ORG_CREDIT_ENFORCEMENT` | launch-critical | Bitcoin cost-control credits | docs/reference/ENV.md=false; worker-config=false | env-doc, worker-code, worker-config, worker-registry |
...
| P0 | `USE_MOCKS` | environment-safety | Environment-wide runtime behavior; must be explicit in launch config. | .env.example=false; docs/reference/ENV.md=false; worker-config=false | deploy-config, env-doc, env-example, other, worker-code, worker-config, worker-registry |
...
| --- | --- | --- | --- | --- |
| `ENABLE_ADES_SIGNATURES` | P2 | roadmap-or-optional | docs/reference/ENV.md=false; worker-config=false | services/worker/src/config.ts:258, services/worker/src/config.ts:597, services/worker/src/middleware/adesFeatureGate.test.ts:4 |
...
| `ENABLE_AI_FRAUD` | P0 | launch-critical | docs/reference/ENV.md=false; frontend-switchboard=true; supabase-seed-default=false; supabase-seed-value=true | .github/workflows/deploy-worker.yml:140, src/lib/switchboard.ts:26, src/lib/switchboard.ts:189 |
...
| `ENABLE_ALLOCATION_ROLLOVER` | P1 | launch-critical | docs/reference/ENV.md=false; worker-config=false | services/worker/src/config.ts:252, services/worker/src/config.ts:594, services/worker/src/jobs/monthly-allocation-rollover.test.ts:32 |
| `ENABLE_ATS_WEBHOOK` | P2 | roadmap-or-optional | docs/reference/ENV.md=false; worker-config=false | services/worker/src/config.test.ts:493, services/worker/src/config.ts:575, services/worker/src/middleware/flagRegistry.ts:50 |
...
| `ENABLE_BATCH_ANCHORING` | P2 | platform-switchboard | frontend-switchboard=false | src/lib/switchboard.ts:23, src/lib/switchboard.ts:168, src/pages/PlatformControlsPage.tsx:60 |
| `ENABLE_CLOUD_LOGGING_SINK` | P3 | unclassified | docs/reference/ENV.md=false; worker-config=false | services/worker/src/config.ts:268, services/worker/src/config.ts:602, services/worker/src/jobs/cloud-logging-drain.ts:44 |
...
| `ENABLE_CONSTRAINED_DECODING` | P3 | unclassified | docs/reference/ENV.md=false; worker-config=false | services/worker/src/ai/nessie.test.ts:260, services/worker/src/ai/nessie.test.ts:264, services/worker/src/ai/nessie.test.ts:301 |
...
| `ENABLE_DOCUSIGN_OAUTH` | P0 | launch-critical | docs/reference/ENV.md=false; worker-config=false | services/worker/src/config.test.ts:386, services/worker/src/config.test.ts:389, services/worker/src/config.test.ts:491 |
| `ENABLE_DOCUSIGN_WEBHOOK` | P0 | launch-critical | docs/reference/ENV.md=false; worker-config=false | services/worker/src/config.test.ts:395, services/worker/src/config.test.ts:398, services/worker/src/config.test.ts:492 |
| `ENABLE_DRIVE_OAUTH` | P0 | launch-critical | docs/reference/ENV.md=false; worker-config=false | services/worker/src/config.test.ts:359, services/worker/src/config.test.ts:362, services/worker/src/config.test.ts:369 |
| `ENABLE_DRIVE_WEBHOOK` | P0 | launch-critical | docs/reference/ENV.md=false; worker-config=false | services/worker/src/api/v1/router.ts:318, services/worker/src/config.test.ts:490, services/worker/src/config.ts:567 |
...
| `ENABLE_EXPIRY_ALERTS` | P3 | unclassified | No parsed default | services/worker/src/middleware/flagRegistry.ts:65, services/worker/src/routes/cron.ts:719, services/worker/src/routes/cron.ts:720 |
...
| `ENABLE_GRACE_EXPIRY_SWEEP` | P3 | unclassified | docs/reference/ENV.md=true | docs/reference/ENV.md:311, docs/runbooks/billing/phase-3-rollover-grace.md:33 |
| `ENABLE_GRC_INTEGRATIONS` | P0 | launch-critical | docs/reference/ENV.md=false; supabase-seed-default=false; supabase-seed-value=false; worker-config=false | services/worker/src/api/v1/router.ts:305, services/worker/src/config.test.ts:489, services/worker/src/config.ts:256 |
...
| `ENABLE_NEW_CHECKOUTS` | P2 | platform-switchboard | frontend-switchboard=true; supabase-seed-default=true; supabase-seed-value=true | src/lib/switchboard.test.ts:84, src/lib/switchboard.ts:20, src/lib/switchboard.ts:147 |
| `ENABLE_ORG_CREDIT_ENFORCEMENT` | P0 | launch-critical | docs/reference/ENV.md=false; worker-config=false | services/worker/src/api/v1/anchor-submit.ts:168, services/worker/src/config.ts:540, services/worker/src/middleware/flagRegistry.ts:29 |
...
| `ENABLE_OUTBOUND_WEBHOOKS` | P2 | platform-switchboard | frontend-switchboard=false; supabase-seed-default=false; supabase-seed-value=false | src/lib/switchboard.ts:19, src/lib/switchboard.ts:140, src/pages/PlatformControlsPage.tsx:80 |
| `ENABLE_PAYMENT_TIERS` | P3 | unclassified | No parsed default | services/worker/src/middleware/paymentTierRouter.ts:13 |
| `ENABLE_PROD_NETWORK_ANCHORING` | P0 | launch-critical | .env.example=false; docs/reference/ENV.md=false; frontend-switchboard=false; supabase-seed-default=false; supabase-seed-value=false; worker-config=false | .env.example:104, .github/workflows/ci.yml:974, .github/workflows/deploy-worker.yml:140 |
...
| `ENABLE_QUEUE_REMINDERS` | P0 | launch-critical | docs/reference/ENV.md=true; worker-config=true | services/worker/agents.md:75, services/worker/src/config.ts:244, services/worker/src/config.ts:590 |
| `ENABLE_REPORTS` | P0 | launch-critical | frontend-switchboard=true; supabase-seed-default=true; supabase-seed-value=true | src/lib/switchboard.test.ts:144, src/lib/switchboard.test.ts:147, src/lib/switchboard.ts:21 |
| `ENABLE_RULES_ENGINE` | P0 | launch-critical | docs/reference/ENV.md=true; worker-config=true | services/worker/agents.md:75, services/worker/src/config.ts:242, services/worker/src/config.ts:589 |
| `ENABLE_RULE_ACTION_DISPATCHER` | P0 | launch-critical | docs/reference/ENV.md=true; worker-config=true | services/worker/src/config.ts:250, services/worker/src/config.ts:593, services/worker/src/jobs/rule-action-dispatcher.test.ts:143 |
...
| `ENABLE_TREASURY_ALERTS` | P1 | launch-critical | docs/reference/ENV.md=true; worker-config=true | services/worker/agents.md:75, services/worker/src/config.test.ts:555, services/worker/src/config.ts:246 |
...
| `ENABLE_VERIFICATION_API` | P0 | launch-critical | .env.example=false; docs/reference/ENV.md=false; frontend-switchboard=true; supabase-seed-default=false; supabase-seed-value=true; worker-config=true | .env.example:63, .github/workflows/ci.yml:973, .github/workflows/deploy-worker.yml:140 |
...
| `ENABLE_VISUAL_FRAUD_DETECTION` | P0 | launch-critical | docs/reference/ENV.md=false; worker-config=false | services/worker/agents.md:130, services/worker/src/api/v1/router.ts:275, services/worker/src/config.test.ts:487 |
| `ENABLE_WEBHOOK_DISPATCH` | P3 | unclassified | No parsed default | docs/stories/22_phase2_agentic_layer.md:85 |
| `ENABLE_WEBHOOK_HMAC` | P0 | launch-critical | docs/reference/ENV.md=true; worker-config=true | services/worker/agents.md:75, services/worker/src/config.ts:248, services/worker/src/config.ts:592 |
| `ENABLE_WORKSPACE_RENEWAL` | P0 | launch-critical | docs/reference/ENV.md=false; worker-config=false | services/worker/src/config.ts:270, services/worker/src/config.ts:603, services/worker/src/jobs/workspace-subscription-renewal.test.ts:149 |
...
| `MAINTENANCE_MODE` | P0 | environment-safety | frontend-switchboard=false; supabase-seed-default=false; supabase-seed-value=false | src/lib/switchboard.test.ts:60, src/lib/switchboard.test.ts:61, src/lib/switchboard.test.ts:75 |
| `USE_MOCKS` | P0 | environment-safety | .env.example=false; docs/reference/ENV.md=false; worker-config=false | .env.example:22, .github/workflows/ci.yml:972, .github/workflows/deploy-worker.yml:140 |
