...
| --- | --- | --- | --- | --- |
| `ENABLE_ADES_SIGNATURES` | P2 | roadmap-or-optional | docs/reference/ENV.md=false; worker-config=false | services/worker/src/config.ts:242, services/worker/src/config.ts:581, services/worker/src/middleware/adesFeatureGate.test.ts:4 |
...
| `ENABLE_ALLOCATION_ROLLOVER` | P1 | launch-critical | docs/reference/ENV.md=false; worker-config=false | services/worker/src/config.ts:236, services/worker/src/config.ts:578, services/worker/src/jobs/monthly-allocation-rollover.test.ts:32 |
| `ENABLE_ATS_WEBHOOK` | P2 | roadmap-or-optional | docs/reference/ENV.md=false; worker-config=false | services/worker/src/config.test.ts:493, services/worker/src/config.ts:559, services/worker/src/middleware/flagRegistry.ts:50 |
...
| `ENABLE_CLOUD_LOGGING_SINK` | P3 | unclassified | docs/reference/ENV.md=false; worker-config=false | services/worker/src/config.ts:252, services/worker/src/config.ts:586, services/worker/src/jobs/cloud-logging-drain.ts:44 |
...
| `ENABLE_DRIVE_WEBHOOK` | P0 | launch-critical | docs/reference/ENV.md=false; worker-config=false | services/worker/src/api/v1/router.ts:318, services/worker/src/config.test.ts:490, services/worker/src/config.ts:551 |
...
| `ENABLE_GRC_INTEGRATIONS` | P0 | launch-critical | docs/reference/ENV.md=false; supabase-seed-default=false; supabase-seed-value=false; worker-config=false | services/worker/src/api/v1/router.ts:305, services/worker/src/config.test.ts:489, services/worker/src/config.ts:240 |
...
| `ENABLE_ORG_CREDIT_ENFORCEMENT` | P0 | launch-critical | docs/reference/ENV.md=false; worker-config=false | services/worker/src/api/v1/anchor-submit.ts:106, services/worker/src/config.ts:524, services/worker/src/middleware/flagRegistry.ts:29 |
...
| `ENABLE_PROD_NETWORK_ANCHORING` | P0 | launch-critical | .env.example=false; docs/reference/ENV.md=false; frontend-switchboard=false; supabase-seed-default=false; supabase-seed-value=false; worker-config=false | .env.example:104, .github/workflows/ci.yml:868, .github/workflows/deploy-worker.yml:140 |
...
| `ENABLE_QUEUE_REMINDERS` | P0 | launch-critical | docs/reference/ENV.md=true; worker-config=true | services/worker/agents.md:75, services/worker/src/config.ts:228, services/worker/src/config.ts:574 |
...
| `ENABLE_RULES_ENGINE` | P0 | launch-critical | docs/reference/ENV.md=true; worker-config=true | services/worker/agents.md:75, services/worker/src/config.ts:226, services/worker/src/config.ts:573 |
| `ENABLE_RULE_ACTION_DISPATCHER` | P0 | launch-critical | docs/reference/ENV.md=true; worker-config=true | services/worker/src/config.ts:234, services/worker/src/config.ts:577, services/worker/src/jobs/rule-action-dispatcher.test.ts:143 |
...
| `ENABLE_TREASURY_ALERTS` | P1 | launch-critical | docs/reference/ENV.md=true; worker-config=true | services/worker/agents.md:75, services/worker/src/config.test.ts:555, services/worker/src/config.ts:230 |
...
| `ENABLE_VERIFICATION_API` | P0 | launch-critical | .env.example=false; docs/reference/ENV.md=false; frontend-switchboard=true; supabase-seed-default=false; supabase-seed-value=true; worker-config=true | .env.example:63, .github/workflows/ci.yml:867, .github/workflows/deploy-worker.yml:140 |
...
| `ENABLE_WEBHOOK_HMAC` | P0 | launch-critical | docs/reference/ENV.md=true; worker-config=true | services/worker/agents.md:75, services/worker/src/config.ts:232, services/worker/src/config.ts:576 |
| `ENABLE_WORKSPACE_RENEWAL` | P0 | launch-critical | docs/reference/ENV.md=false; worker-config=false | services/worker/src/config.ts:254, services/worker/src/config.ts:587, services/worker/src/jobs/workspace-subscription-renewal.test.ts:149 |
...
| `USE_MOCKS` | P0 | environment-safety | .env.example=false; docs/reference/ENV.md=false; worker-config=false | .env.example:22, .github/workflows/ci.yml:866, .github/workflows/deploy-worker.yml:140 |
