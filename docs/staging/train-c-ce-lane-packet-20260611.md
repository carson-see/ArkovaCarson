...
- 2026-06-11 13:42 EDT: Non-mutating fake-ID probes returned expected 404s: `/api/v1/verify/ARK-TRAIN-C-FAKE` -> `Record not found`; `/api/v1/credentials/ARK-TRAIN-C-FAKE/ctdl` -> `not_found`.

## Remaining Before Soak

- Run a real CE/CTDL targeted smoke using approved staging data or CE examples, with redacted logs only.
