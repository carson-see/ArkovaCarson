...
> Run `2026-08-12T17:07:40Z` · rig `https://arkova-worker-fullsoak-2026-08-staging-270018525501.us-central1.run.app` · Supabase `gnkuaywlpmsaezwvlvhk`
...
> Repo HEAD `c0a51e260ebbad623adb4d086921f0dac8508111`
...
**TypeScript legs are worktree builds** (worktree c0a51e260 — the npm packages are unpublished (Phase A)). That is the §5.1 S12/S13 false-pass
...
`SDK_INTEGRATION: 22 pass / 6 fail / 0 skip — FAIL`
