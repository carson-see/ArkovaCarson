...
> **Status:** **BASELINE PROD LEDGER ROW RECORDED 2026-05-04** in project `vzwyaatejekddvltxyye` via Supabase MCP `execute_sql` (single ledger INSERT, RETURNING confirmed `version=00000000000000, name=baseline_at_main_HEAD`). `0295_pr700_rls_baseline_reconciliation.sql` was applied to prod on 2026-05-06 after explicit operator authorization, but prod recorded it under timestamp version `20260506113532` instead of numeric version `0295`; under the clarified Arkova migration rules, this is a ledger-reconciliation blocker before Done. Schema evidence and the blocker are captured in [`PR700_PROD_0295_VERIFICATION_2026-05-06.md`](./PR700_PROD_0295_VERIFICATION_2026-05-06.md). Anchor batch-policy evidence is captured in [`PR700_ANCHOR_POLICY_VERIFICATION_2026-05-06.md`](./PR700_ANCHOR_POLICY_VERIFICATION_2026-05-06.md). PR #700 is not merge-ready until the prod ledger is reconciled, CI/review are green, and worker/staging validation evidence is captured.
...
- `0295_pr700_rls_baseline_reconciliation.sql` is applied to prod `vzwyaatejekddvltxyye`; schema/RLS evidence is captured in [`PR700_PROD_0295_VERIFICATION_2026-05-06.md`](./PR700_PROD_0295_VERIFICATION_2026-05-06.md). The prod ledger row is `20260506113532 / 0295_pr700_rls_baseline_reconciliation`, which is now a blocker because the required local migration version is `0295`. Migration Drift rerun [25429502352 / 74603343923](https://github.com/carson-see/ArkovaCarson/actions/runs/25429502352/job/74603343923) passed under the older name-normalizing gate; #700 now adds a stricter PR-owned numeric ledger check.
