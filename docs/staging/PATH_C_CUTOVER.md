...
- `0295_pr700_rls_baseline_reconciliation.sql` is applied to prod `vzwyaatejekddvltxyye`; schema/RLS evidence is captured in [`PR700_PROD_0295_VERIFICATION_2026-05-06.md`](./PR700_PROD_0295_VERIFICATION_2026-05-06.md). The original Management API apply recorded timestamp row `20260506113532 / 0295_pr700_rls_baseline_reconciliation`; after explicit sign-off, it was reconciled to `0295 / pr700_rls_baseline_reconciliation`. #700 now adds a stricter PR-owned numeric ledger check so that timestamped rows with matching names cannot hide numeric ledger drift again.
