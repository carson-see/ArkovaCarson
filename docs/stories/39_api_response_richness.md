...
**Files:** `services/worker/src/routes/verify.ts` (Zod schema), `docs/api/openapi.yaml`, `packages/sdk/src/types.ts`, `packages/arkova-py/src/arkova/models.py` _(SCRUM-1566 consolidation: `sdks/python/` and `packages/python-sdk/` removed; `packages/arkova-py/` is canonical)_
