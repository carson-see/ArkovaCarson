...
_Last updated: 2026-03-21 (OPS-08 WIF fixed + deployed rev 00024, AuthCallbackPage OAuth race fix, anchor processing confirmed on signet) | Re-prioritized each session per CLAUDE.md rules_
...
| # | ID | Issue | Status |
|---|-----|-------|--------|
| 9 | ~~OPS-01~~ | ~~Apply migrations 0059-0073 to production Supabase + regenerate types~~ | **DONE** — All migrations applied |
