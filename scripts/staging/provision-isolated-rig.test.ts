...
${source}
probe_tuned_gemini_preclock '${accessToken}' '733013' 2>&1
code=$?
printf '\nPROBE_EXIT=%s\n' "$code"
exit 0
`;
...
${functionSource}
raw="$(/bin/cat '${fixture}')"
parse_genie_deploy_operation_name "$raw" '733013'
`;
    expect(execFileSync('bash', ['-c', testScript], { encoding: 'utf8' }).trim()).toBe(
...
CLOUD_RUN_REGION='us-central1'
${functionSource}
raw='{"name":"projects/999999999999/locations/us-central1/endpoints/733013/operations/123456"}'
parse_genie_deploy_operation_name "$raw" '733013'
`;
    expect(() => execFileSync('bash', ['-c', testScript], {
      encoding: 'utf8',
...
CLOUD_RUN_REGION='us-central1'
${functionSource}
raw='{"name":"projects/270018525501/locations/us-central1/endpoints/733013/operations/not-numeric"}'
parse_genie_deploy_operation_name "$raw" '733013'
`;
    expect(() => execFileSync('bash', ['-c', testScript], {
      encoding: 'utf8',
