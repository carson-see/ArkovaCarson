...
const expectedScope = {
  ...
  endpointId: '6072023465' as const,
  endpointResource: 'projects/arkova1/locations/us-central1/endpoints/6072023465' as const,
  ...
  deployedModelId: '6072023467' as const,
...
describe('RIG-G1 immutable spend approval', () => {
  ...
  it.each([
    ...
    ['deployed model ID', { deployedModelId: '60720234652' }],
