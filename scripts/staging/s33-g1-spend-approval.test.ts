...
const expectedScope = {
  ...
  endpointId: '202607202346550001' as const,
  endpointResource: 'projects/arkova1/locations/us-central1/endpoints/202607202346550001' as const,
  ...
  deployedModelId: '202607202346551001' as const,
...
describe('RIG-G1 immutable spend approval', () => {
  ...
  it.each([
    ...
    ['deployed model ID', { deployedModelId: '2026072023465500012' }],
