...
function admission(): Record<string, unknown> {
  const approval = {
    ...
    candidate: {
      ...
      vertexEndpointId: '733013',
      vertexEndpoint: 'projects/arkova1/locations/us-central1/endpoints/733013',
  ...
  return {
    ...
    critical_config: {
      ...
      gemini_tuned_model: 'projects/arkova1/locations/us-central1/endpoints/733013',
    ...
    rig_r: {
      ...
      runtime_impersonation_member:
        'serviceAccount:270018525501-compute@developer.gserviceaccount.com',
      vertex_endpoint: 'projects/arkova1/locations/us-central1/endpoints/733013',
      vertex_model: 'projects/270018525501/locations/us-central1/models/6611494259700793344',
      deployed_model_id: '7330131',
      chain_mode: 'mocked',
