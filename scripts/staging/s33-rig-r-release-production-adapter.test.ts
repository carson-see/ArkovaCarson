...
function admission(): Record<string, unknown> {
  const approval = {
    ...
    candidate: {
      ...
      vertexEndpointId: '202607202346550002',
      vertexEndpoint: 'projects/arkova1/locations/us-central1/endpoints/202607202346550002',
      ...
      checkpointId: '6',
      deployedModelId: '202607202346552001',
  ...
  return {
    ...
    critical_config: {
      ...
      gemini_tuned_model: 'projects/arkova1/locations/us-central1/endpoints/202607202346550002',
    ...
    rig_r: {
      ...
      runtime_impersonation_member:
        'serviceAccount:270018525501-compute@developer.gserviceaccount.com',
      vertex_endpoint: 'projects/arkova1/locations/us-central1/endpoints/202607202346550002',
      vertex_model: 'projects/270018525501/locations/us-central1/models/6611494259700793344',
      deployed_model_id: '202607202346552001',
      chain_mode: 'mocked',
