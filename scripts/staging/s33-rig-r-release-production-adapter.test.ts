...
const confirmation =
  'START_RIG_R:rig-r-approval-1:s33-r-release-v6:lease-s33-r-release:real-provider-recovery-8';
...
function admission(): Record<string, unknown> {
  const approval = {
    ...
    candidate: {
      ...
      vertexEndpointId: '733002',
      vertexEndpoint: 'projects/arkova1/locations/us-central1/endpoints/733002',
  ...
  return {
    ...
    rig_r: {
      ...
      vertex_endpoint: 'projects/arkova1/locations/us-central1/endpoints/733002',
      vertex_model: 'projects/270018525501/locations/us-central1/models/6611494259700793344',
      deployed_model_id: '7330021',
      chain_mode: 'mocked',
