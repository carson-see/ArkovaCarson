...
RIG_G1_B_ENDPOINT="projects/arkova1/locations/us-central1/endpoints/733001"
RIG_G1_B_ENDPOINT_ID="733001"
RIG_G1_B_DEPLOYED_MODEL_ID="7330011"
...
RIG_B1_APPROVAL_VERIFIER_SHA256="76fb833c523ecc77ac3c6d7b50a422f9151cbb3a80e6ef8607b63f1ded33b7d6"
...
if [[ "$RIG_ID" == "RIG-B1" ]]; then
  ...
  if [[ $IS_RIG_G1_A -eq 1 ]]; then
    ...
    echo "ERROR: RIG-G1-B teardown requires exact endpoint 733001/deployment 7330011 and preserves the canonical v6 model." >&2
    exit 2
  fi
