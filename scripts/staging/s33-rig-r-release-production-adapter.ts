...
const START_ATTEMPT_ID = 'real-provider-recovery-19';
...
const ENDPOINT_ID = '202607202346550002';
...
const DEPLOYED_MODEL_ID = '202607202346552001';
...
const admissionSchema = z.object({
  ...
  critical_config: z.object({
    ...
    db_enable_verification_api: z.literal('true'),
    db_enable_ai_extraction: z.literal('true'),
