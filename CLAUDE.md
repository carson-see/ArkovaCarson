...
> **🔧 2026-04-21 10-STORY SPRINT (PR #462):** 10 Jira stories shipped across MCP security, react-hooks cleanup, calibration view, and bug fixes. **SCRUM-916** react-hooks v7 compiler cleanup: 36 files refactored (purity, immutability, preserve-manual-memoization, set-state-in-effect patterns) with targeted `eslint-disable` comments. **SCRUM-917** calibration-features view (migration 0222) replacing unsafe `anchors` type cast. **SCRUM-920** MCP HMAC-SHA256 envelope signing (`mcp-hmac.ts`, WebCrypto, 4 tests). **SCRUM-921** scoped `mcp_anchor_document` RPC (migration 0223, SECURITY DEFINER). **SCRUM-922** Zod format validators + error redaction in MCP tools. **SCRUM-925** NCA-FU2b jurisdiction deep-link forwarding to SecureDocumentDialog. **SCRUM-953** unlimited plan progress bar fix in ApiUsageDashboard. Plus self-hosted Terraform scaffold, CI migration-drift workflow, and MCP idempotency dedup. 1,357 frontend tests + 153 test files green + typecheck clean + lint clean. BUG-2026-04-21-014 logged.
> **🩹 2026-04-21 TOP-10 UAT BUG-FIX SPRINT (batch 1 + 2 — 13 bugs resolved):** See BUG-2026-04-21-001..013 in [bug_log.md](./docs/bugs/bug_log.md).
> **Stats:** 214 migrations (0000-0223 — prod synced through 0221; 0222 calibration_features view + 0223 mcp_anchor_document RPC pending deploy) | ~4,588 tests (1,357 frontend + 3,208 worker + 23 sanitizer tests) | **355 stories** (348 complete + 7 externally blocked). Remaining Blocked (8 stories) are genuinely external: pentest vendor (SCRUM-517), SOC 2 auditor (SCRUM-522), Kenya ODPC filing (SCRUM-576/577), GEO marketing launches (SCRUM-477/478/479), SEC IAPD API replacement (SCRUM-727), NCA follow-up (SCRUM-893). | 24/24 audit + 9 pentest findings resolved | AI: **Gemini 2.5 Flash (prod extraction, v5-reasoning tuned `endpoints/8811908947217743872`, single deployed Vertex endpoint)** — v6/v7 tuned and eval'd but did NOT cut over (v7 failed DoD 2026-04-16 PM, v7.1 surgical retrain planned); Nessie v27.3 FCRA UNDER_REVIEW + v28.0 HIPAA + v29.0 FERPA **QUARANTINED** (NVI-15) | 1.41M+ public records | 1.41M+ SECURED anchors (mainnet)
...
_Directive version: 2026-04-21 (10-story sprint PR #462 + top-10 UAT bug-fix sprint) | 214 migrations (0223, prod through 0221) | ~4,588 tests (1,357 frontend + 3,208 worker + 23 sanitizer) | **355 stories** (348 complete + 7 externally blocked) | GME 20/20 | NCE 20/20 | NMT 14/14 | **NVI 18/18** | **NCA-FU1 6/6** | **API-RICH 5/5** | **INTL 6/6** | **TRUST 2/7** | **2026-04-21 10-story sprint:** SCRUM-916 react-hooks v7 cleanup (36 files), SCRUM-917 calibration-features view (migration 0222), SCRUM-920 MCP HMAC signing, SCRUM-921 scoped anchor RPC (migration 0223), SCRUM-922 Zod validators + error redaction, SCRUM-925 jurisdiction deep-link, SCRUM-953 unlimited bar fix. **Closed — needs migration story:** Tailwind 3→4 (SCRUM-915). | Nessie v27.3 FCRA / v28.0 HIPAA / v29.0 FERPA deployed; v27.3 UNDER_REVIEW + v28/v29 QUARANTINED per NVI-15 | Gemini v5-reasoning prod, v6 cutover pending, v7 failed DoD | Major remaining: Tailwind 4 migration (SCRUM-915), REG (26 not started), TRUST-01/02/03, pentest + SOC 2 external, `idx_brin_anchors_created` maintenance-window apply_
