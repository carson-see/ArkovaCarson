...
_Directive version: 2026-04-18 (evening sprint, PR #419) | 209 migrations (0000-0218, prod through 0185, 19 pending) | 4,402 tests (+23 vs AM) | ~343/344 stories complete | GME: 20/20 DONE | NCE: 20/20 DONE | INT: 8/9 (webhook CRUD open) | NMT: 14/14 DONE | **NVI: 18/18 DONE** | **NCA-FU1: 6/6 DONE** (PR #419 — PDF vector gauge, Nessie RAG enrichment flag-gated, UAT runbook) | **API-RICH: 5/5 DONE** | **INTL: 6/6 DONE** | **TRUST: 2/7** | **SALES-ACCURACY: 4/4 DONE (PR #419 — SCRUM-899 Kenya residency, SCRUM-900 PROOF-SIG signed bundle, SCRUM-901 SELF-HOST ref architecture, SCRUM-902 AWS removal from customer-facing docs)** | NPH-16 runbook shipped in #414 (operator deploy tracked in SCRUM-892) | Nessie v27.3 FCRA / v28.0 HIPAA / v29.0 FERPA deployed; v27.3 UNDER_REVIEW + v28/v29 QUARANTINED per NVI-15 | Gemini v5-reasoning prod, v6 cutover pending, v7 failed DoD | Major remaining: DEP (9 not started), REG (26 not started), TRUST-01/02/03 Q1 (low-cost high-value), pentest + SOC 2 external engagement_
